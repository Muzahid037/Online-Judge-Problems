...
void solve()
{
	...
	string s;
	cin>>s;
	string s1="",s2="",s3,res="2020";
	for(int i=0;i<4;i++) s1+=s[i];
	for(int i=n-4;i<n;i++) s2+=s[i];
	if(s1==res || s2==res)
    {
        cout<<"YES"<<endl;
    }
    else if(s1[0]=='2' && s2[1]=='0' && s2[2]=='2' && s2[3]=='0')
    {
         cout<<"YES"<<endl;
    }
    else if(s1[0]=='2' && s1[1]=='0' && s2[2]=='2' && s2[3]=='0')
    {
         cout<<"YES"<<endl;
    }
    else if(s1[0]=='2' && s1[1]=='0' && s1[2]=='2' && s2[3]=='0')
    {
         cout<<"YES"<<endl;
    }
    else cout<<"NO"<<endl;
